...
CREATE TABLE `QuestionMistakeReview` (
    ...
    INDEX `QMR_user_latest_idx`(`userId`, `isLatestForQuestion`),
    INDEX `QMR_user_question_latest_idx`(`userId`, `questionId`, `isLatestForQuestion`),
    INDEX `QMR_user_cause_latest_idx`(`userId`, `mistakeCause`, `isLatestForQuestion`),
    INDEX `QMR_user_tag_latest_idx`(`userId`, `tagId`, `isLatestForQuestion`),
    INDEX `QMR_user_created_idx`(`userId`, `createdAt`),
